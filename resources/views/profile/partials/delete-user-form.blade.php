<section class="bg-white p-6 shadow-md rounded">
    <header class="mb-4">
        <h2 class="text-lg font-medium text-[#184E77]">Delete Account</h2>
        <p class="mt-1 text-sm text-gray-600">
            Once your account is deleted, all of its resources and data will be permanently deleted. Before deleting your account, please download any data or information that you wish to retain.
        </p>
    </header>
<div class="w-full flex justify-center items-center">
    <button class="px-8 py-1 bg-red-600 text-white rounded hover:bg-red-700" onclick="document.getElementById('delete-account-modal').classList.remove('hidden')">Delete Account</button>
